...
// Rutas protegidas - ADMIN y PROVEEDOR
router.post('/', verifyToken, checkRole(['ADMIN', 'PROVEEDOR']), marcasController.crear);
...
router.put('/:id', verifyToken, checkRole(['ADMIN', 'PROVEEDOR']), marcasController.actualizar);
